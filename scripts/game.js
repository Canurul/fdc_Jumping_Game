...
let __player_jump_duration = parseInt(BODY_COMPUTED_STYLE.getPropertyValue('--jump-duration'));
...
window.addEventListener("resize", (event) => {
    ...
    __player_jump_duration = parseInt(BODY_COMPUTED_STYLE.getPropertyValue('--jump-duration'));
